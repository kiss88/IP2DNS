...
public class MainRun {
	...
	public static void init() throws IOException {
		...
		/*
		 * 详见
		 * https://docs.aliyun.com/?spm=5176.776555948.1863381.554.7Lk02r#/pub/dns
		 * */
	    ...
	    public static void main(String[] args) throws IOException, InterruptedException{
	    	 init() ;
	/*    	DescribeDomainRecordsRequest request3=new DescribeDomainRecordsRequest();
	    	DescribeDomainRecordsResponse response3;
	    	request3.setDomainName("freshz.cn");
	    	 try {
